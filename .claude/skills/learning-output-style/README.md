...
2. **Border highlight** — Show the Accent accent border
...
• The shadow uses Ink (not black) for warmth
─────────────────────────────────────────────────
```

## <PROJECT>-Specific Guidance

For <PROJECT> projects, Claude guides you on:
...
*Adapted for <PROJECT> with designer-focused learning*
