# <PROJECT> Component Patterns Reference

> Quick reference for common <PROJECT> component patterns to use in implementation plans.
...
<div
  className={cn(
    ...
    'border border-border-secondary',
    'rounded-xl p-6',
    'shadow-sm shadow-[rgb(25,25,25)]/10', // Ink shadow, not black
    'hover:shadow-md'
  )}
>
  {children}
...
<div
  className={cn(
    ...
    'border-t-fg-brand-primary' // Accent accent
  )}
/>
```
