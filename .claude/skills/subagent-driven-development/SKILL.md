...
**Fresh agent per task + <PROJECT>-aware reviews = high quality, fast iteration**
...
- [ ] Task 3: Add styling with <PROJECT> tokens
...
│  → Include <PROJECT> design system requirements                       │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│  ANSWER QUESTIONS                                               │
│  → Clarify requirements before work begins                      │
│  → Provide <PROJECT> pattern references if needed                     │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
...
### <PROJECT> Design System Requirements
...
- Brand color (Accent) for CTAs only
...
- Confirm understanding of <PROJECT> tokens needed
...
- [ ] <PROJECT> design tokens used throughout
- [ ] No hardcoded colors
...
- [ ] <PROJECT> design tokens used (verify in code)
...
6. **Verify <PROJECT> compliance** - Design system is non-negotiable
