...
- Brand color (Accent/--bg-brand-solid) for CTAs and active states ONLY
...
[Include relevant <PROJECT> pattern from component-patterns.md]
...
- [ ] Accent (--bg-brand-solid) only for:
  - Primary CTA buttons
