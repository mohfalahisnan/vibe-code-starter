...
For <PROJECT> projects, insights focus on:

| Topic | Example Insight |
|-------|-----------------|
| **Design tokens** | "Using `var(--fg-primary)` instead of `<COLOR_PRIMARY>` means this adapts to theme changes" |
...
| **Warm neutrals** | "Ink (<COLOR_PRIMARY>) is warmer than pure black, creating a more inviting feel" |
...
*Adapted for <PROJECT> with designer-focused explanations*
