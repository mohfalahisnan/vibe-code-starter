# <PROJECT> Code Quality Review Walkthrough
...
**Finding**: Using `blue-500` instead of brand color (Accent).
...
describe('FilterPanel', () => {
  ...
  it('uses <PROJECT> styling tokens', () => {...});
});
```
...
````markdown
## <PROJECT> Code Quality Review: FilterPanel
...
- Recommendation: Add tests for filter interaction and <PROJECT> compliance
