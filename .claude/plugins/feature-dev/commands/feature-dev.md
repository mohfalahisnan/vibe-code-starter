...
- **Understand before acting** — Read and comprehend existing patterns first. For <PROJECT> projects, understand our design tokens and component patterns.
...
**For <PROJECT> projects**: Always check:
- `app/theme.css` — Design tokens
- `components/ui/` — Existing components
- `.claude/CLAUDE.md` — Design guidelines
...
4. Follow <PROJECT> conventions:
   ...
   - Use warm neutrals (Ink/Paper), not black/white
...
1. Launch 3 reviewer agents:
   ...
   - **<PROJECT> Conventions** — Does it match our design system?
...
**For <PROJECT> projects**, reviewers check:
...
- Added <PROJECT>-specific styling via wrapper
...
*Adapted for <PROJECT> design system and designer-friendly workflow*
