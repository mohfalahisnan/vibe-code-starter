...
- **Checks <PROJECT> conventions** — Automatically verifies design token usage, accessibility, border philosophy

## <PROJECT> Integration

For <PROJECT> projects, the plugin automatically checks:
...
- **Warm neutrals** — Ink/Paper instead of black/white
