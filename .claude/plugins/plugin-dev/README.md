...
```bash
/plugin-dev:create-plugin A plugin to enforce <PROJECT> design system patterns
```
...
## <PROJECT> Plugin Ideas

Some useful plugins you could build for <PROJECT>:
...
```markdown
---
description: Show <PROJECT> color tokens
---

Display the <PROJECT> color palette:
- Accent (<COLOR_ACCENT>) — Primary accent
- Ink (<COLOR_PRIMARY>) — Dark neutral
- Paper (<COLOR_BACKGROUND>) — Light neutral
```
...
*Adapted for <PROJECT> with designer-friendly explanations*
