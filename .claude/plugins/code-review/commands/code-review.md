...
description: Code review a pull request with <PROJECT> design system awareness
---

Provide a code review for the given pull request.

> For <PROJECT> projects, this review includes **design system compliance** checking alongside bug detection.
...
- **For <PROJECT> projects**: Check for `<PROJECT>-DESIGN-SYSTEM.md` and `theme.css` references
...
**For <PROJECT> projects, also check:**
...
- Warm neutrals (Ink/Paper vs pure black/white)
...
- **For <PROJECT>**: Hardcoded colors that should use tokens, missing accessibility patterns
...
Post: "No issues found. Checked for bugs, CLAUDE.md compliance, and <PROJECT> design system patterns."
...
## <PROJECT> Design System Checklist

When reviewing <PROJECT> code, specifically check:

| Pattern      | Correct                   | Incorrect             |
| ------------ | ------------------------- | --------------------- |
| Colors       | `var(--fg-primary)`       | `#000000`             |
| Backgrounds  | `var(--bg-secondary)`     | `#ffffff`             |
| Brand accent | `var(--brand-primary)`    | `<COLOR_ACCENT>` (hardcoded) |
...
_Adapted for <PROJECT> design system awareness_
